...
namespace Infiniminer
{
    public class InterfaceEngine
    {
        ...
        public void Render(GraphicsDevice graphicsDevice)
        {
            ...
            // Show the altimeter.
            int altitude = (int)(_P.playerPosition.Y - GlobalVariables.MAPSIZE + InfiniminerGame.GROUND_LEVEL);
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.M) && _P.playerPosition.Y <= GlobalVariables.MAPSIZE - InfiniminerGame.GROUND_LEVEL && _P.chatMode == ChatMessageType.None)
